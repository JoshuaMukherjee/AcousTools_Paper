...
Visualise(*ABC(0.005), xs, res=(300,300), link_ax=None,arrangement=(3,2) , depth=-1,
        ...
        clr_labels=["Normalised Pressure", "Normalised Pressure", "Normalised Pressure", "Normalised Pressure", "Normalised Pressure", "Normalised Pressure"],
        titles=[str(f)+'kHz' for f in fs_kHz])
