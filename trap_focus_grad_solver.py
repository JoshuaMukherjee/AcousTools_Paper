...
x = gradient_descent_solver(p, objective=objective, board=board, log=True, objective_params={'alpha':1.5e10}, iters=1000)

Visualise(*ABC(0.05), x, points=p, colour_functions=[propagate_abs, gorkov], link_ax=None, arangement=(2,1))
